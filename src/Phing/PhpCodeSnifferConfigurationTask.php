...
class PhpCodeSnifferConfigurationTask extends \Task {
  ...
  public function main() {
    ...
    $root_element->setAttribute('name', 'Invoicing_default');
    $document->appendChild($root_element);

    // Add the description.
    $element = $document->createElement('description', 'Default PHP CodeSniffer configuration for the Invoicing project.');
